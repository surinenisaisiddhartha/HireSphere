...
const AdminResumes = () => {
  // Use functional accessors for all columns to fix TypeScript inference issues when mixing string keys and functions
  const columns = [
    { 
      header: 'Candidate', 
      accessor: (r: Resume) => (
    ...
    { 
      header: 'Actions', 
      accessor: () => (
        <Button variant="ghost" size="sm">Score AI</Button>
      )
    },
  ];
