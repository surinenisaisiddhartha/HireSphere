...
const AuditLogs = () => {
  ...
  const columns = [
    ...
    { header: 'User', accessor: (l: any) => l.user },
    { header: 'Company', accessor: (l: any) => l.company },
    { header: 'Module', accessor: (l: any) => <span className="px-2 py-0.5 bg-gray-100 rounded text-xs text-gray-600">{l.module}</span> },
    { header: 'Timestamp', accessor: (l: any) => l.timestamp },
  ];
